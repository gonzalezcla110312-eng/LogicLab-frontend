...
function Panel_Administrador({usuario, setPagina}){
  ...
  const cargarDashboard = async () => {
    try {
      ...
      setGananciasHoy(
        Number(ingresos.ingresos_totales || 0)
      );
  ...
  // Si entramos a sección panel recargamos el dashboard
  useEffect(() => {
    if (seccion === "panel") {
      cargarDashboard();
    }
  ...
  const estadisticas =
    resumenDashboard.estadisticas || {};

  const ingresos =
    resumenDashboard.ingresos || {};

  const topPlatillos =
    resumenDashboard.platillos_top || [];

  const alertasPedidos =
    resumenDashboard.alertas_pedidos || [];

  const tendenciaPedidos =
    resumenDashboard.tendencia_pedidos || [];
    ...
    <div className="admin-layout-container">
      ...
      <aside className="sidebar-admin">
        ...
        <nav className="sidebar-menu">
          ...
          <button
            className={`menu-item ${
              seccion === "menus" ? "active" : ""
            }`}
            onClick={() => setSeccion("menus")}
          >
            Menús
          </button>
          ...
          <div className="admin-dash-shell">
            ...
            <header className="admin-dash-header">
              ...
              <div>
                ...
                <p className="admin-dash-subtitle">
                  Resumen operativo de hoy, {hoyLabel}.
                </p>
            ...
            <section className="admin-kpi-grid">
              ...
              <article className="admin-kpi-card">
                ...
                <p className="admin-kpi-value admin-kpi-value-money">
                  {formatPrecio(gananciasHoy)} COP
                </p>
              ...
              <article className="admin-kpi-card admin-kpi-card-soft">
                ...
                <p className="admin-kpi-value">
                  {Number(
                    estadisticas.pedidos_cancelados || 0
                  )}
                </p>
              ...
              <article className="admin-kpi-card admin-kpi-card-soft">
                ...
                <p className="admin-kpi-value">
                  {Number(
                    estadisticas.pedidos_en_proceso || 0
                  )}
                </p>
              ...
              <article className="admin-kpi-card admin-kpi-card-soft">
                ...
                <p className="admin-kpi-label">
                  Demora prep. promedio
                </p>

                <p className="admin-kpi-value">
                  {Number(
                    estadisticas.promedio_demora_preparacion_min || 0
                  ).toFixed(1)}m
                </p>
            ...
            <section className="admin-dash-two-col">
              ...
              <article className="admin-panel-card">
                ...
                {menuDelDia.length === 0 ? (
                  ...
                  <div className="admin-empty-placeholder">
                    ...
                    <span>
                      Ve a la sección Menús para publicarlo.
                    </span>
                  ...
                  <div className="admin-scroll-list">
                    ...
                    {menuPlatos.length > 0 && (
                      ...
                      <div className="admin-list-group">
                        ...
                        <p className="admin-list-group-label">
                          Platos
                        </p>
                        ...
                        {menuPlatos.map((p) => (
                          ...
                          <div
                            key={`plato-${p.id}-${p.NombrePlato}-${p.Precio}`}
                    ...
                    {menuBebidas.length > 0 && (
                      ...
                      <div className="admin-list-group">
                        ...
                        {menuBebidas.map((p) => (
                          ...
                          <div
                            key={`bebida-${p.id}-${p.NombrePlato}-${p.Precio}`}
                            className="admin-list-row"
                          >
              ...
              <article className="admin-panel-card admin-panel-card-center">
                ...
                <div className="admin-circle-progress-wrap">
                  ...
                  <svg
                    viewBox="0 0 100 100"
                    className="admin-circle-progress-svg"
                    aria-hidden="true"
                  >
                ...
                <p className="admin-mesas-caption">
                  {mesasOcupadas} de {totalMesas} mesas ocupadas
                </p>

                <p className="admin-mesas-caption-soft">
                  Ocupación actual: {porcentajeOcupadas}%
                </p>
            ...
            <section className="admin-dash-two-col">
                ...
                {topPlatillos.length === 0 ? (
                  ...
                  <div className="admin-scroll-list">
                    ...
                    {topPlatillos.map((p) => (
                      ...
                      <div
                        key={`${p.platillo_id}-${p.platillo_nombre}`}
                        className="admin-list-row"
                      >
              ...
              <article className="admin-panel-card">
                ...
                {alertasPedidos.length === 0 ? (
                  ...
                  <div className="admin-empty-placeholder">
                    No hay pedidos fuera del umbral
                  </div>
                    ...
                    {alertasPedidos.map((a) => (
                      ...
                      >
                        ...
                        <p className="admin-alert-title">
                          Mesa #{a.mesa_numero} · Pedido #{a.id}
                        </p>

                        <p className="admin-alert-subtitle">
                          {a.minutos_abierto} min abierto ·{" "}
            ...
            <section className="admin-panel-card">
              ...
              {tendenciaPedidos.length === 0 ? (
                ...
                <div className="admin-empty-placeholder">
                  Sin tendencia para el rango seleccionado
                </div>
          ...
          <div className="admin-dash-shell">
            ...
            <header className="admin-dash-header">
              ...
              <div>
                ...
                <p className="admin-dash-subtitle">
                  Resumen de ingresos y rendimiento de ventas.
                </p>
            ...
            <section className="admin-dash-two-col">
              ...
              <article className="admin-panel-card">
                ...
                <div className="admin-panel-card-head">
                  ...
                  <h2 className="admin-panel-card-title">
                    Platillos que generan ingresos
                  </h2>
